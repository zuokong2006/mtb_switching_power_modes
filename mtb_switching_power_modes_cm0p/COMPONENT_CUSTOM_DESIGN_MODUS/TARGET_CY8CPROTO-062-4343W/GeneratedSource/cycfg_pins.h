...
#endif //defined (CY_USING_HAL)
#define KIT_BTN1_ENABLED 1U
#define KIT_BTN1_PORT GPIO_PRT0
#define KIT_BTN1_PORT_NUM 0U
...
#if defined (CY_USING_HAL)
	#define KIT_BTN1_HAL_PORT_PIN P0_4
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define KIT_BTN1_HAL_IRQ CYHAL_GPIO_IRQ_FALL
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define KIT_BTN1_HAL_DIR CYHAL_GPIO_DIR_BIDIRECTIONAL 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define KIT_BTN1_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_PULLUP
#endif //defined (CY_USING_HAL)
#define KIT_LED1_ENABLED 1U
#define KIT_LED1_PORT GPIO_PRT13
#define KIT_LED1_PORT_NUM 13U
#define KIT_LED1_PIN 7U
#define KIT_LED1_NUM 7U
...
#endif
#define KIT_LED1_HSIOM ioss_0_port_13_pin_7_HSIOM
#define KIT_LED1_IRQ ioss_interrupts_gpio_13_IRQn
#if defined (CY_USING_HAL)
	#define KIT_LED1_HAL_PORT_PIN P13_7
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define KIT_LED1_HAL_IRQ CYHAL_GPIO_IRQ_NONE
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define KIT_LED1_HAL_DIR CYHAL_GPIO_DIR_OUTPUT 
#endif //defined (CY_USING_HAL)
#if defined (CY_USING_HAL)
	#define KIT_LED1_HAL_DRIVEMODE CYHAL_GPIO_DRIVE_STRONG
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t KIT_BTN1_obj;
#endif //defined (CY_USING_HAL)
extern const cy_stc_gpio_pin_config_t KIT_LED1_config;
#if defined (CY_USING_HAL)
	extern const cyhal_resource_inst_t KIT_LED1_obj;
#endif //defined (CY_USING_HAL)
