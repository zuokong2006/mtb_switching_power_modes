...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t KIT_BTN1_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = KIT_BTN1_PORT_NUM,
		.channel_num = KIT_BTN1_PIN,
	};
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	const cyhal_resource_inst_t KIT_LED1_obj = 
	{
		.type = CYHAL_RSC_GPIO,
		.block_num = KIT_LED1_PORT_NUM,
		.channel_num = KIT_LED1_PIN,
	};
#endif //defined (CY_USING_HAL)
...
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&KIT_BTN1_obj);
#endif //defined (CY_USING_HAL)

	Cy_GPIO_Pin_Init(KIT_LED1_PORT, KIT_LED1_PIN, &KIT_LED1_config);
#if defined (CY_USING_HAL)
	cyhal_hwmgr_reserve(&KIT_LED1_obj);
#endif //defined (CY_USING_HAL)
